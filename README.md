...
- [Kestra](https://kestra.io/) - Kestra is a event-driven, language-agnostic orchestration and scheduling platform to manage millions of workflows declaratively in code. ([Source Code](https://github.com/kestra-io/kestra/)) `Apache-2.0` `Java/Docker`
